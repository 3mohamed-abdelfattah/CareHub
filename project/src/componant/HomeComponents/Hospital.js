...
import DOCM from "../Photos/Hospitallogo.png";
...
export default function Hospital() {
  ...
  return (
    ...
    <h1 className="txtdoc">بيئةٌ آمنةٌ وراحةٌ تامة، تُحيط بك في اشهر مستشفيات بني سويف</h1>
    <h1 style={{ color: '#ff0505', textAlign: 'center' }}>تقنياتٌ حديثةٌ وخبراتٌ مُتراكمة، تُجتمع في مستشفياتنا لخدمتك</h1>
