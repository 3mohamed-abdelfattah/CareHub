...
import DOCM from "../Photos/Companylogo.png";
...
export default function Company() {
  ...
  return (
    ...
    <h1 className="txtdoc">مع أشهر شركات الأدوية في بني سويف</h1>
    <h1 style={{ color: '#ff0505', textAlign: 'center' }}>نُشاركك رحلتك نحو الشفاء، من خلال أدويةٍ مُبتكرةٍ وعالية الجودة</h1>
