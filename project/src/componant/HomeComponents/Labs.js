...
import DOCM from "../Photos/LabsLogo.png";
...
export default function Labs() {
  ...
  return (
    ...
    <h1 className="txtdoc">مع أشهر معامل التحاليل في بني سويف</h1>
    <h1 style={{ color: '#ff0505', textAlign: 'center' }}>نُقدم لك نتائج موثوقة، تُساعدك على اتّخاذ قرارات صحية سليمة</h1>
