...
import ChatbotNutral from "../ChatBOTS/ChatbotNutural";

const itemsPerPage = 5;

export default function NuturlDoc() {
  useEffect(() => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/Physical_Therapist");
  ...
  return (
    ...
    <h1 className="txtdoc">أحدث التقنيات في  العلاج</h1>
    <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل أطباء العلاج الطبيعي في بني سويف</h1>
