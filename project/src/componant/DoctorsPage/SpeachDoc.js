...
export default function SpeachDoc() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/Speech_therapist");
  ...
  return (
    <div>
      ...
      <h1 className="txtdoc">توفير رعاية طبية</h1>
      <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل أطباء التخاطب في بني سويف</h1>
