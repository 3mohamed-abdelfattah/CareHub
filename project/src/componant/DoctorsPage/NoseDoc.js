...
export default function NoseDoc() {
  useEffect(() => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/Otorhinolaryngologist");
  ...
  return (
    ...
    <h1 className="txtdoc">توفير بيئة طبية آمنة ومريحة</h1>
    <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل أطباء الأنف والأذن والحنجرة في بني سويف</h1>
