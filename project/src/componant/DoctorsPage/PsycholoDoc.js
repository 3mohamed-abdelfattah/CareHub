...
export default function PsycholoDoc() {
  useEffect(() => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/Psychiatrist1");
  ...
  return (
    <div>
      ...
      <h1 className="txtdoc">خبرة واسعة في العلاج</h1>
      <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل الأطباء النفسيين  في بني سويف</h1>
