...
export default function SurgryDoc() {
  const mystyle = {
    overflow: 'hidden',
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/surgery");
  ...
  return (
    ...
    <h1 className="txtdoc">رعاية جراحية بأعلى معايير الجودة والسلامة</h1>
    <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل أطباء الجراحة في بني سويف</h1>
    ...
    <span className="icon-arrow">
      ...
      <div className="common_questions-D">
        ...
        <div className="question-D">
          <h4>ما هي الخطوات التحضيرية قبل عملية جراحية؟</h4>
        ...
        <div className={cardtoggle1 ? "show" : "hide"} style={mystyle}>
          ...
          <p>
          <>.يشمل التحضير فحصًا شاملاً، والامتناع عن تناول الطعام والسوائل قبل العملية، والتوقف عن بعض الأدوية قبل الموعد المحدد</>
          </p>
        ...
        <div className="question-D">
          <h4>ما هي التوقعات بعد عملية جراحية؟</h4>
          <svg width="15"height="10" viewbox="0 0 42 25">
            <path d="M3 3L21 21L39 3" stroke ="white" stroke-width="7" stroke-linecap="round" />
          </svg>
        </div>
        <div className={cardtoggle2 ? "show" : "hide"} style={mystyle}>
          ...
          <p>
          <>.يختلف ذلك حسب نوع الجراحة، ولكن يجب توقع فترة استراحة ومتابعة طبيب الجراحة لضمان التعافي السليم</>
          </p>
        ...
        <div className="question-D">
          <h4>هل هناك مخاطر محتملة مع الجراحة التجميلية؟</h4>
          <svg width="15"height="10" viewbox="0 0 42 25">
            <path d="M3 3L21 21L39 3" stroke ="white" stroke-width="7" stroke-linecap="round" />
          </svg>
        </div>
        <div className={cardtoggle3 ? "show" : "hide"} style={mystyle}>
          ...
          <p>
          <>.كما هو الحال مع أي عملية جراحية، هناك مخاطر محتملة مثل التورم والنزيف. يجب مناقشة هذه المخاطر مع الطبيب قبل القرار بالجراحة</>
          </p>
        ...
        <div className="question-D">
          <h4>ما هي فترة التعافي المتوقعة بعد جراحة تجميلية؟</h4>
          <svg width="15"height="10" viewbox="0 0 42 25">
            <path d="M3 3L21 21L39 3" stroke ="white" stroke-width="7" stroke-linecap="round" />
          </svg>
        </div>
        <div className={cardtoggle4 ? "show" : "hide"} style={mystyle}>
          ...
          <p>
          <>.تختلف فترة التعافي حسب نوع الجراحة، ولكن يجب توقع فترة من الراحة وتجنب النشاط البدني الشاق</>
          </p>
        ...
        <div className="question-D">
          <h4>كيف يتم تحديد ضرورة استئصال ورم خبيث؟</h4>
          <svg width="15"height="10" viewbox="0 0 42 25">
            <path d="M3 3L21 21L39 3" stroke ="white" stroke-width="7" stroke-linecap="round" />
          </svg>
        </div>
        <div className={cardtoggle5 ? "show" : "hide"} style={mystyle}>
          ...
          <p>
          <>.يتم تحديد ذلك استنادًا إلى تقييم الأطباء المختصين، وغالبًا ما يتضمن ذلك الاستناد إلى نتائج التصوير الطبي والتحاليل</>
          </p>
        ...
        <div className="question-D">
          <h4>ما هي الخيارات المتاحة لتخدير المريض خلال الجراحة؟</h4>
          <svg width="15"height="10" viewbox="0 0 42 25">
            <path d="M3 3L21 21L39 3" stroke ="white" stroke-width="7" stroke-linecap="round" />
          </svg>
        </div>
        <div className={cardtoggle6 ? "show" : "hide"} style={mystyle}>
          ...
          <p>
          <>.يتم اختيار نوع التخدير استنادًا إلى نوع الجراحة وحالة المريض، ويشمل ذلك التخدير العام والتخدير الموضعي</>
          </p>
