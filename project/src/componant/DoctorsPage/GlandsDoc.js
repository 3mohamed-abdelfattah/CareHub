...
export default function GlandsDoc() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/Endocrinologist");
  ...
  return (
    <div>
      ...
      <h1 className="txtdoc">اهتم بصحتك الهرمونية</h1>
      <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل أطباء الغدد في بني سويف</h1>
