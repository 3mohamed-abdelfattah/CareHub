...
export default function HeartDoc() {
  const mystyle = {
    overflow: 'hidden',
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/Cardiologist");
  ...
  return (
    ...
    <h1 className="txtdoc">تأكد من صحة قلبك</h1>
    <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل أطباء القلب في بني سويف</h1>
