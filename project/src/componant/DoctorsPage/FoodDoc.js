...
export default function FoodDoc() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/Nutrition_Specialist");
  ...
  return (
    ...
    <h1 className="txtdoc">أتبع نظامًا غذائيًا صحيًا</h1>
    <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل أخصائيين تغذية في بني سويف</h1>
