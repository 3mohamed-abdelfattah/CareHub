...
export default function StomchDoc() {
  const mystyle = {
    overflow: 'hidden',
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/Gastroenterology");
  ...
  return (
    ...
    <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل أطباء باطنه في بني سويف</h1>
