...
const ToggleHandler6 = ()=> {
  ...
  <section>
    ...
    <div class="question-D">
      <h4>ما هي الأعراض الرئيسية لأمراض الجهاز التنفسي؟</h4>
    ...
    <div className={cardtoggle1 ? "show" : "hide"} style={mystyle}>
      ...
      <p>
      <>.تشمل الأعراض صعوبة التنفس، السعال المزمن، والألم في الصدر. يجب استشارة الطبيب إذا ظهرت هذه الأعراض</>
      </p>
    ...
    <div class="question-D">
      <h4>كيف يمكن التعامل مع الربو؟</h4>
      <svg width="15"height="10" viewbox="0 0 42 25">
        <path d="M3 3L21 21L39 3" stroke ="white" stroke-width="7" stroke-linecap="round" />
      </svg>
    </div>
    <div className={cardtoggle2 ? "show" : "hide"} style={mystyle}>
      ...
      <p>
      <>.يشمل العلاج استخدام مضادات الالتهاب والمسكنات، وأحيانًا استخدام موانع الاستجابة السريعة</>
      </p>
    ...
    <div class="question-D">
      <h4>ما هي الفحوصات الشائعة لتقييم صحة الرئتين؟</h4>
      <svg width="15"height="10" viewbox="0 0 42 25">
        <path d="M3 3L21 21L39 3" stroke ="white" stroke-width="7" stroke-linecap="round" />
      </svg>
    </div>
    <div className={cardtoggle3 ? "show" : "hide"} style={mystyle}>
      ...
      <p>
      <>.تشمل الفحوصات التصوير الصدري (الأشعة السينية) واختبارات وظائف الرئة وفحص الدم</>
      </p>
    ...
    <div class="question-D">
      <h4>كيف يتم تشخيص الالتهاب الرئوي؟</h4>
      <svg width="15"height="10" viewbox="0 0 42 25">
        <path d="M3 3L21 21L39 3" stroke ="white" stroke-width="7" stroke-linecap="round" />
      </svg>
    </div>
    <div className={cardtoggle4 ? "show" : "hide"} style={mystyle}>
      ...
      <p>
      <>.يُجرى تقييم طبي شامل يشمل الفحص السريري والفحوصات التشخيصية مثل الأشعة السينية وتحليل الدم</>
      </p>
    ...
    <div class="question-D">
      <h4>ما هي الخطوات الرئيسية في علاج التهاب الشعب الهوائية المزمنة؟</h4>
      <svg width="15"height="10" viewbox="0 0 42 25">
        <path d="M3 3L21 21L39 3" stroke ="white" stroke-width="7" stroke-linecap="round" />
      </svg>
    </div>
    <div className={cardtoggle5 ? "show" : "hide"} style={mystyle}>
      ...
      <p>
      <>.يشمل العلاج استخدام مضادات الالتهاب غير الستيرويدية ومضادات الاستجابة السريعة عند الحاجة</>
      </p>
    ...
    <div class="question-D">
      <h4>هل هناك أسلحة رذاذية فعالة لعلاج أمراض التنفس؟</h4>
      <svg width="15"height="10" viewbox="0 0 42 25">
        <path d="M3 3L21 21L39 3" stroke ="white" stroke-width="7" stroke-linecap="round" />
      </svg>
    </div>
    <div className={cardtoggle6 ? "show" : "hide"} style={mystyle}>
      ...
      <p>
      <>.نعم، توجد أجهزة استنشاق تحتوي على موانع ومسكنات للتسهيل في علاج أمراض التنفس</>
      </p>
