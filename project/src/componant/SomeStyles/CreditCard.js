...
import "../SomeStyles/CrefitCard.css"
...
return (
    ...
    <div className="flip-card-front">
        ...
        <svg className="logocard" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={36} height={36} viewBox="0 0 48 48">
        ...
        <p className="numbercard">9759 2484 5269 6576</p>
        <p className="valid_thru">VALID THRU</p>
        <p className="date_8264">1 2 / 2 4</p>
        <p className="namecard">BRUCE WAYNE</p>
    </div>
    <div className="flip-card-back">
        <div className="stripcard" />
        <div className="mstrip" />
        <div className="sstrip">
        <p className="codecard">***</p>
        </div>
    </div>
    </div>
</div>
