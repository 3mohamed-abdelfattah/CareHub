    ...
    <div className="parentS" >
        <div className="SignDivS">
            <form onSubmit={Submit} className="form1S">
                ...
                <input id="first-name" type="text" placeholder="الاسم الأول" className="placeholdS" value={firstname} onChange={(e)=>setfName(e.target.value)}/>
                {firstname <2 && accept &&(<p className="error">يرجي ادخال اسم المستخدم</p>)}

                {/* <label htmlFor="last-name">الاسم الأخير</label>  */}
                <input id="last-name" type="text" placeholder="الاسم الأخير" className="placeholdS" value={lastname} onChange={(e)=>setlName(e.target.value)}/>
...
{/*
                <input id="number" type="number" placeholder="رقم الموبايل" className="placeholdS" value={phonenum} onChange={(e)=>setphonenum(e.target.value)}/>
                <input id="date" type="date" placeholder="تاريخ الميلاد" className="placeholdS" value={date} onChange={(e)=>setdate(e.target.value)}/>
 */}
