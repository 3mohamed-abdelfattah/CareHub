...
import DOCM from "../Photos/defultcenter.png";
...
export default function DefaultCenters() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get("http://localhost:5000/api/c&mc");
    ...
    return (
        <div>
            ...
            <h1 className="txtdoc">مع أشهر العيادات الشاملة في بني سويف</h1>
            <h1 style={{ color: '#ff0505', textAlign: 'center' }}>ضمان حصولك على الرعاية الصحية التي تستحقها</h1>
