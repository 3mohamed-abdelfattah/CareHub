...
import ChatbotChild from "../ChatBOTS/ChatBotChild";
...
export default function ChildDoc() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/pediatrician");
  ...
  return (
    <div>
      ...
      <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل أطباء الأطفال في بني سويف</h1>
