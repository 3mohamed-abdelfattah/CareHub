...
export default function BrainDoc() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/doctors/Neurologist");
  ...
  return (
    <div>
      ...
      <h1 className="txtdoc">عالج أمراض الجهاز العصبي بكفاءة</h1>
      <h1 style={{ color: '#ff0505', textAlign: 'center' }}>...مع أفضل أطباء المخ والأعصاب في بني سويف</h1>
